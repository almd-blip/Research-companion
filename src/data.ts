...
export const INITIAL_JOURNEYS: ResearchJourney[] = [
  {
    ...
    chapters: [
      { id: 'ch-1', title: 'Chapter 1: Introduction and Scope', status: 'completed', content: 'This research positions museum curation within the history of colonial archiving. Standard UX practices assume a universal, rational user...' },
      { id: 'ch-2', title: 'Chapter 2: Decolonial Critical Theory', status: 'drafting', content: 'Drawing from Mignolo and Tuhiwai Smith, we outline an epistemic decolonial framework. We analyze how database structures categorize artifacts into strict taxonomies that lack relational nuance...' },
  ...
  },
  {
    ...
    chapters: [
      { id: 'ch-2-1', title: 'Introduction', status: 'drafting', content: 'Writing academic papers is a high-cognitive-load task. Researchers must weave together multiple lines of evidence, theoretical models, and empirical data, all while keeping citations strictly correct...' },
