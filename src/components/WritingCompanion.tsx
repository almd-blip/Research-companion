    ...
    <div className="flex flex-col gap-4 h-full" id="writing-companion-module">
        ...
        <div className="space-y-4 flex-1 flex flex-col">
          <div className="flex justify-between items-center pb-3 border-b border-stone-150">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {loadingAnalysis ? 'Checking...' : 'Check References'}
              </button>
            </div>
          </div>
          ...
          <textarea
            ...
            placeholder="Outline your thoughts, connect concepts, and type drafts here... When ready, click 'Check References' on the top right to check your claims against your saved articles."
          />
        </div>
      ...
      <div className="w-full lg:w-96 bg-stone-50 dark:bg-stone-900/40 border border-stone-200 dark:border-stone-800 rounded-lg p-5 flex flex-col">
        <div className="flex items-center gap-2 mb-4 border-b border-stone-200 dark:border-stone-800 pb-3">
          <h3 className="font-sans font-medium text-xs text-[#912A4A] dark:text-rose-400 tracking-wide">Fact & Source Checker</h3>
        </div>

        {loadingAnalysis ? (
          <div className="flex-1 flex flex-col items-start justify-start py-16 space-y-3">
            <p className="font-sans text-xs text-stone-500 italic text-left px-4">Checking your writing against your saved articles to make sure your statements match your sources...</p>
          </div>
        ) : analysisResult ? (
          <div className="flex-1 flex flex-col">
            ...
            <div className="grid grid-cols-4 gap-1 border-b border-stone-200 dark:border-stone-800 pb-3 mb-4 text-[10px] font-sans">
              <button
                ...
                title="Claims that need more source proof"
              >
                Unsupported
              </button>
              <button
                ...
                title="Claims supported by your saved articles"
              >
                Supported
              </button>
              <button
                ...
                title="Ideas that disagree with saved articles"
              >
                Debates
              </button>
              <button
                ...
                title="Ideas for organizing your writing"
              >
                Structure
              </button>
            </div>
          ...
          <div className="flex-1 flex flex-col items-start justify-start py-24 text-left text-stone-400 dark:text-stone-500 font-sans text-xs">
            <p className="px-4">Click "Check References" above to check statement support, track contradictions, and organize your ideas.</p>
          </div>
        )}
      </div>
